...
const apiKey = "SIXkMbmAWVZtBkfRDJyqZzdWcC7IG7pPku7ai5LrlOdXAHkY0VlcIpCZ";
const partialUrl = "https://api.pexels.com/v1/search?query=";
document
  .querySelector("#loadImages")
  .addEventListener("click", () => getInfos(partialUrl + "gatti"));

document
  .querySelector("#loadSecondaryImages")
  .addEventListener("click", () => getInfos(partialUrl + "cani"));
